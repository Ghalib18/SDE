...
const achievements = [
  ...
  },
  {
   ...
   {
    id: "InnoByte Service",
    title: "Frontend Intern at InnoByte Service",
  ...
  },
  {
    ...
    description: [
      ...
      "LeetCode maximum rating: 1700",
      "Global Rank 814 out of 30,000+ in Biweekly Contest 148",
      "CodeChef maximum rating: 1500, Global Rank 633",
    ],
    icon: Code,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Explore my journey—a fusion of academic excellence and professional prowess. From honing my skills in CSE to contributing value at esteemed organizations.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed max-w-4xl">
              {
                "I am a passionate software developer pursuing B.Tech in Computer Science at BIT Sindri with an 8.9 CGPA. My trajectory is a testament to dedication and innovation. Dive into the chronicles of my education and work history, where every experience has shaped me into the versatile professional I am today."
              }
            </p>
          </motion.section>
