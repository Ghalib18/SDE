...
const stats = [
  ...
  { label: "Best Global Rank", value: "814", icon: TrendingUp, color: "from-amber-500 to-orange-500" },
  { label: "Contests Participated", value: "30+", icon: Trophy, color: "from-emerald-500 to-teal-500" },
  { label: "Max Rating", value: "1824", icon: Award, color: "from-blue-500 to-cyan-500" },
]
